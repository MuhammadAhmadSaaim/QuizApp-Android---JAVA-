        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (rgOptions.getCheckedRadioButtonId() != -1 && !answered) {
                    ...
                    Toast.makeText(QuizActivity.this, "Already answered, click Next to continue.", Toast.LENGTH_SHORT).show();
                } else {
        ...
        btnShowAnswer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!answered) {
                    ...
                    Toast.makeText(QuizActivity.this, "Correct Answer: " + correctAnswer, Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(QuizActivity.this, "You have already answered this question.", Toast.LENGTH_SHORT).show();
                }
            }
        });
